...
TArray<uint8> FInternetAddrNetSockets::GetRawIp() const
{
...
void FInternetAddrNetSockets::SetRawIp(const TArray<uint8>& RawAddr)
{
...
void FInternetAddrNetSockets::SetIp(const TCHAR* InAddr, bool& bIsValid)
{
...
void FInternetAddrNetSockets::SetPort(int32 InPort)
{
	if (GetProtocolType() == FNetworkProtocolTypes::SteamNetSocketsP2P)
	{
...
int32 FInternetAddrNetSockets::GetPort() const
{
	if (GetProtocolType() == FNetworkProtocolTypes::SteamNetSocketsP2P)
	{
...
void FInternetAddrNetSockets::SetAnyAddress()
{
...
FString FInternetAddrNetSockets::ToString(bool bAppendPort) const
{
...
uint32 FInternetAddrNetSockets::GetTypeHash() const
{
...
FName FInternetAddrNetSockets::GetProtocolType() const
{
	...
	{
		return FNetworkProtocolTypes::SteamNetSocketsP2P;
	}

	return FNetworkProtocolTypes::SteamNetSocketsIP;
}
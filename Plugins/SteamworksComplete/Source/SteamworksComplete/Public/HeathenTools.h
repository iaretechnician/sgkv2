...
/************************************************
* Utilities few stubborn concepts for Steamwors
* that require a bit of extra handling and tooling
*************************************************/

UENUM(BlueprintType, Category = "Steamworks Complete")
...
UENUM(BlueprintType, Category = "Steamworks Complete", meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = "true"))
...
UENUM(BlueprintType, meta = (Bitflags, UseEnumValuesAsMaskValuesInEditor = "true"), Category = "Steamworks Complete")
...
struct FSteamworksInitializationResponse
{
    GENERATED_BODY()
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Steamworks Initialization Response")
    bool success;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Achievement Status")
    bool Achieved;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Stat Status")
    bool Valid;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Steamworks Complete")
    FString key;
...
public:
    UPROPERTY(BlueprintReadWrite, Category = "Steamworks Complete")
    int32 authTicketHandle;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Leaderboard Entry")
    int32 AppId;
...
public:
    ...
    UPROPERTY(EditAnywhere, meta = (Bitmask, BitmaskEnum = UESteamItemFlags), BlueprintReadWrite, Category = "Steamworks Complete")
    int32 flags;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Remote Storage File Info")
    FString fileName;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Remote Storage File Quota")
    int64 TotalCapacity;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Remote Storage UGC Detail")
    int32 appId;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Item Download Info")
    bool requestResult;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Item Update Info")
    UEItemUpdateStatus status;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Item Preview Info")
    bool requestResult;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Item Preview Info")
    UEItemPreviewType type;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Query Children Info")
    bool requestStatus;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Details")
    int64 fileId;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "UGC Details")
    UERemoteStoragePublishedFileVisibility visibility;

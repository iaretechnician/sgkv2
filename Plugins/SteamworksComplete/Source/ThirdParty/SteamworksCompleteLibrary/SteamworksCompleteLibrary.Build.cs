...
public class SteamworksCompleteLibrary : ModuleRules
{
	public SteamworksCompleteLibrary(ReadOnlyTargetRules Target) : base(Target)
	{
        Type = ModuleType.External;
        //PublicSystemIncludePaths.Add("$(ModuleDir)/sdk/public");
        ...
        PublicIncludePaths.Add("$(ModuleDir)/sdk");
    }
}
